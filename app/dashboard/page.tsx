    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {cards.map((card, index) => (
          <Card key={index} className="group transition-all duration-300 hover:shadow-lg hover:-translate-y-1 bg-[#a0dcfc]/60 dark:bg-[#0a4e63] backdrop-blur-sm border border-gray-200 dark:border-gray-700">
